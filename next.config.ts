...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/pieeg-shop", destination: "/hardware", permanent: true },
      { source: "/pieeg-shop/index.html", destination: "/hardware", permanent: true },
      { source: "/index.html@p=74", destination: "/hardware", permanent: true },
      ...
      { source: "/signal-processing-with-python-for-neuroscience-practical-course", destination: "/software", permanent: true },
      { source: "/google-colab-page", destination: "/software", permanent: true },
      { source: "/google-colab-page/index.html", destination: "/software", permanent: true },
      { source: "/books", destination: "/software", permanent: true },
      { source: "/books/index.html", destination: "/software", permanent: true },
      ...
      { source: "/hardware/eeg_courses/index.html", destination: "/software", permanent: true },
