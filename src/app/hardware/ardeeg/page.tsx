...
export default function ArdEEGProductPage() {
  return (
    <main className="flex-1">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            <div className="lg:col-span-2 rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900 overflow-hidden flex flex-col min-h-70 lg:min-h-110">
              <div className="flex-1 flex items-center justify-center p-12">
                <Image
                  src="/products/ardeeg-top.png"
                  alt="ardEEG — PCB top view"
                  width={520}
                  height={400}
              ...
              <div className="px-5 py-3.5 border-t border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 flex items-center justify-between">
                <span className="text-xs font-semibold uppercase tracking-widest text-zinc-400">PCB Top View</span>
            ...
            <div className="flex flex-col gap-4">
              <div className="rounded-2xl border border-zinc-800 bg-zinc-950 overflow-hidden flex flex-col min-h-50 lg:min-h-0 lg:flex-1">
                <div className="flex-1 flex items-center justify-center p-6 relative overflow-hidden">
                  <div className="absolute inset-0 bg-linear-to-br from-green-500 to-emerald-600 opacity-15" />
                  <Image
                    src="/products/ardeeg.png"
                    alt="ardEEG — product photo"
                    width={260}
                    height={200}
                ...
                <div className="px-4 py-2.5 border-t border-zinc-800 flex items-center justify-between">
                  <span className="text-xs font-semibold uppercase tracking-widest text-zinc-500">Product Photo</span>
                  <span className="text-xs text-zinc-700">2 / 3</span>
                </div>
              </div>
              <div className="rounded-2xl border border-zinc-800 bg-zinc-950 overflow-hidden flex flex-col min-h-50 lg:min-h-0 lg:flex-1">
                <div className="flex-1 flex items-center justify-center p-6 relative overflow-hidden">
                  <div className="absolute inset-0 bg-linear-to-br from-green-500 to-emerald-600 opacity-10" />
                  <Image
                    src="/products/ardeeg-setup.jpg"
                    alt="ardEEG — setup with Arduino"
                    width={260}
                    height={200}
                    className="object-contain max-h-28 w-auto relative z-10"
                    style={{ filter: "drop-shadow(0 0 20px rgba(255,255,255,0.08))" }}
                ...
                <div className="px-4 py-2.5 border-t border-zinc-800 flex items-center justify-between">
                  <span className="text-xs font-semibold uppercase tracking-widest text-zinc-500">Arduino Setup</span>
      ...
      <section className="py-10 bg-linear-to-br from-green-500 via-emerald-600 to-teal-600 text-white">
