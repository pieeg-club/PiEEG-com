...
export default function MicroBCIProductPage() {
  return (
    <main className="flex-1">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            <div className="lg:col-span-2 rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900 overflow-hidden flex flex-col min-h-70 lg:min-h-110">
              <div className="flex-1 flex items-center justify-center p-12">
                <Image
                  src="/products/microbci-main.png"
                  alt="MicroBCI — board overview"
                  width={520}
                  height={400}
              ...
              <div className="px-5 py-3.5 border-t border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 flex items-center justify-between">
                <span className="text-xs font-semibold uppercase tracking-widest text-zinc-400">Board Overview</span>
            ...
            <div className="flex flex-col gap-4">
              <div className="rounded-2xl border border-zinc-800 bg-zinc-950 overflow-hidden flex flex-col min-h-50 lg:min-h-0 lg:flex-1">
                <div className="flex-1 flex items-center justify-center p-6 relative overflow-hidden">
                  <div className="absolute inset-0 bg-linear-to-br from-teal-500 to-cyan-600 opacity-15" />
                  <Image
                    src="/products/microbci-eeg.png"
                    alt="MicroBCI — EEG setup"
                    width={260}
                    height={200}
                ...
                <div className="px-4 py-2.5 border-t border-zinc-800 flex items-center justify-between">
                  <span className="text-xs font-semibold uppercase tracking-widest text-zinc-500">Clean View</span>
                  <span className="text-xs text-zinc-700">2 / 3</span>
                </div>
              </div>
              <div className="rounded-2xl border border-zinc-800 bg-zinc-950 overflow-hidden flex flex-col min-h-50 lg:min-h-0 lg:flex-1">
                <div className="flex-1 flex items-center justify-center p-6 relative overflow-hidden">
                  <div className="absolute inset-0 bg-linear-to-br from-teal-500 to-cyan-600 opacity-10" />
                  <Image
                    src="/products/microbci-setup.jpg"
                    alt="MicroBCI — connection diagram with EEG cap"
                    width={260}
                    height={200}
                    className="object-contain max-h-28 w-auto relative z-10"
                    style={{ filter: "drop-shadow(0 0 20px rgba(255,255,255,0.08))" }}
                ...
                <div className="px-4 py-2.5 border-t border-zinc-800 flex items-center justify-between">
                  <span className="text-xs font-semibold uppercase tracking-widest text-zinc-500">System Setup</span>
      ...
      <section className="py-10 bg-linear-to-br from-teal-500 via-cyan-600 to-blue-600 text-white">
