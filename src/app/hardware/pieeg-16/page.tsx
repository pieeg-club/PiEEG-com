...
import { ExternalLink, Code2 as GitHubIcon, Cpu, Zap, Signal, Shield, Layers } from "lucide-react";
...
export default function PiEEG16ProductPage() {
  return (
    <main className="flex-1">
            ...
            <div className="flex items-center justify-center">
              <div className="relative w-full max-w-md aspect-video rounded-2xl overflow-hidden shadow-2xl border border-zinc-200 dark:border-zinc-700">
                <iframe
                  width="100%"
                  height="100%"
                  src="https://www.youtube.com/embed/tjCazk2Efqs"
                  title="PiEEG-16 Video"
      ...
      <section className="py-10 bg-linear-to-br from-blue-500 via-indigo-600 to-purple-600 text-white">
