...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      // Accessories
      { source: "/cap-eeg-kit/", destination: "/hardware", permanent: true },
      { source: "/cap-eeg-kit-8-channels-with-wet-electrodes/", destination: "/hardware", permanent: true },
      { source: "/conductive-gel-for-eeg/", destination: "/hardware", permanent: true },
      { source: "/low-cost-16-channels-eeg-cap/", destination: "/hardware", permanent: true },
